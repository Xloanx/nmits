...
//else
//  {
//   echo"<span class='pageInfoErr'>We don't know the module that generated this test page</span>";
//}
...
if(isset($_POST['submittest'])){
  $transact = $examiner->scoreAndGrade($_POST['r1'],$_POST['r2'],$_POST['r3'],$_POST['r4'],$_POST['r5'],
...
<div id ='alert' class='alert'>
  ...
  Best of luck!!!<br/><br/>
  <button type="submit"  onclick="startTest()" class="w3-btn w3-large w3-round-xxlarge w3-dark-grey w3-hover-light-grey" style="font-weight:900;">Continue >>></button> </a>
</div>
<!---regulations;--->
...
$radio_family_name= $radio_name[$i];
?>
<!--  echo<<<_content1
  	      <div id="testclass" class="testclass">  -->
  	          <p><h3 ><b>QUESTION <?php echo $displayed_test_number; ?></b></h3></p>
  	          <p><h3 ><b><?php echo $test_details[1]; ?></b></h3></p>
  	          <p><label class="container"><?php echo $test_details[2]; ?><input type="radio" name="<?php echo $radio_family_name; ?>" class="w3-left" value="a" ><span class="checkmark"></span></label></p>
  	          <p><label class="container"><?php echo $test_details[3]; ?><input type="radio" name="<?php echo $radio_family_name; ?>" class="w3-left" value="b" ><span class="checkmark"></span></label></p>
  	          <p><label class="container"><?php echo $test_details[4]; ?><input type="radio" name="<?php echo $radio_family_name; ?>" class="w3-left" value="c" ><span class="checkmark"></span></label></p>
  	          <p><label class="container"><?php echo $test_details[5]; ?><input type="radio" name="<?php echo $radio_family_name; ?>" class="w3-left" value="d" ><span class="checkmark"></span></label></p>
  	          <p><label class="container"><?php echo $test_details[6]; ?><input type="radio" name="<?php echo $radio_family_name; ?>" class="w3-left" value="e" ><span class="checkmark"></span></label></p>
              <p><input type="Hidden" id="testnumber" name="<?php echo $test_name[$i]; ?>" value="<?php echo $test_number; ?>"/></p>
              <p><input type="Hidden" id="ans" name="<?php echo $ansName[$i]; ?>" value="<?php echo $test_details[7]; ?>"/></p>
              <p><input type="Hidden" id="curr_modul" name="curr_modul" value="<?php echo $current_moduleno; ?>"/></p>
              <hr/ width=100%>
<!---_content1;--->
<?php 
}
...
<!---echo<<<_content1  -->
              ...
              <button type="submit" id='submittest' name='submittest' class="w3-btn ww3-large w3-round-xxlarge w3-dark-grey w3-hover-light-grey" style="font-weight:900;">SUBMIT</button> </a>
            </form>
          </div>
<!---_content1;
