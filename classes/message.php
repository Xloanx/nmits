...
function scoreAndGrade($rad1,$rad2,$rad3,$rad4,$rad5,$rad6,$rad7,$rad8,$rad9,$rad10,
                       $test1,$test2,$test3,$test4,$test5,$test6,$test7,$test8,$test9,$test10,
                        $ans1,$ans2,$ans3,$ans4,$ans5,$ans6,$ans7,$ans8,$ans9,$ans10,
                          $curr_module,$num_questions,$userid)
  {
    ...
    if($rad1 == "" || $rad2 == "" || $rad3 == "" || $rad4 == "" || $rad5 == ""||
      ...
      {
        $transact = "<span class='pageInfoErr'>At least one question was not answered, please answer the question </span>";
        exit;
      }
  ...
  /////////////////////////////////////////////////////DO SCORING/////////////////////////////////////////////////////
    ...
    function fetchResult($userid, $current_moduleno){
    		$this->userid 	= $this->db->sanitizeEntry($userid);
    		$this->current_moduleno  	= $this->db->sanitizeEntry($current_moduleno);
    		$sql = "SELECT score, grade, remark FROM progresstab WHERE userid='$this->userid' AND moduleid = '$this->current_moduleno' ORDER BY moduleid DESC LIMIT 1";
    		$query = $this->db->query($sql);
